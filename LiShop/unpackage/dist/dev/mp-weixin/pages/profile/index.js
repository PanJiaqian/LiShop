  ...
  methods: {
    ...
    loadUserProfile(token) {
      ...
      return api_index.getUserProfile({ token }).then((res) => {
        ...
        common_vendor.index.__f__("error", "at pages/profile/index.vue:725", "Fetch user profile failed", err);
      });
    },
    login() {
      common_vendor.index.navigateTo({ url: "/pages/login/index" });
    ...
    handleSave() {
      ...
      api_index.updateUserProfile({
        ...
        common_vendor.index.hideLoading();
        common_vendor.index.__f__("error", "at pages/profile/index.vue:793", err);
    ...
    sendCode() {
      ...
      api_index.sendSecurityCode({ token }).then((res) => {
        ...
        common_vendor.index.hideLoading();
        common_vendor.index.__f__("error", "at pages/profile/index.vue:843", err);
    ...
    confirmSecurityEdit() {
      ...
      if (promise) {
        promise.then((res) => {
          ...
          common_vendor.index.hideLoading();
          common_vendor.index.__f__("error", "at pages/profile/index.vue:879", err);
